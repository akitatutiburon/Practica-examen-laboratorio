...
if(isset($_GET['id'])){
    ...
    $eliminar = "DELETE FROM clientes WHERE id_cliente = $variable";
    ...
    $error_de_eliminacion_mascotas = "Cannot delete or update a parent row: a foreign key constraint fails (`tienda_mascotas`.`adopciones`, CONSTRAINT `adopciones_ibfk_3` FOREIGN KEY (`id_cliente`) REFERENCES `clientes` (`id_cliente`))"; 

...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 08, 2023 at 09:00 PM
...
(28, 'Mami', 'perro', '', 0, 2, 0, 'perro de Mauri S', 6, 3, 12.65);
...
--
ALTER TABLE `mascotas`
  MODIFY `id_mascota` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

...
// $sql = "SELECT rol_usuario FROM usuarios WHERE id_usuario = '1'";
...
//         header("Location: http://localhost/laboratorio_3ro/practica%20examen%20final/Practica-examen-laboratorio/pag_principal.php");
//         exit;
//     }
// } else {
